...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "db_TiketKu";
    ...
    public static final String COL_TEMPAT_DUDUK = "tempat_duduk";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_ASAL + " TEXT, " + COL_TUJUAN + " TEXT" + ", " + COL_TANGGAL + " TEXT, " + COL_DEWASA + " TEXT, "+ COL_ANAK + " TEXT, "
                + COL_TEMPAT_DUDUK + " TEXT)");
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('Adelina@gmail.com','adelina','Adelina Yoga');");
    }
